...
?>
<h3 class="titulo">Editar Planificación</h3>
<div class="panel panel-default">
	<div class="panel-heading">
		<div class="panel-title">Editar Planificación</div>
	</div>
	<div class="panel-body">
		<div class="row">
			...
			<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" ng-controller="validarPlanificacion">
				...
				<span ng-repeat="objeto in editPlanificacion">
          ...
          <div class="form-group">
						...
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
							...
							placeholder="Ejemplo: DD-MM-YYYY" ng-model="objeto.fecha_produccion" required readonly>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
							<select class="form-control" ng-change="validacion()" name="linea" id="linea" title="Seleccione una opción" ng-model="objeto.linea" required>
								<option value="">Seleccione una opción</option>
								<option ng-repeat="objeto2 in lineasProduccion" value="{{objeto2.id}}">{{ objeto2.nombre }}</option>
							</select>
