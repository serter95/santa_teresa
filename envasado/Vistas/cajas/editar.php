...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 box-principal">
	<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 areaTrabajo">
		<h3 class="titulo">Editar Cajas</h3>
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="panel-title">Editar Caja</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" ng-controller="validarCajas">
						...
						<?php require_once 'Vistas/template/plantillas/campoRequerido.php'; ?>
							...
							<span ng-repeat="objeto in editCaja">
								...
								<div class="form-group">
									...
									<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
										...
										placeholder="Ejemplo: Superior 750ml" ng-model="objeto.nombre" 
								...
								<div class="form-group">
									...
									<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
										...
										placeholder="Ejemplo: 12" ng-model="objeto.cantidad_botellas" 
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
									<a class="fancybox" rel="gallery" href="<?php echo URL; ?>Vistas/template/imagenes/cajas/<?php echo $array['foto']; ?>">
										<img class="col-lg-3 col-md-3 col-sm-3 col-xs-12 img-thumbnail" 
										src="<?php echo URL; ?>Vistas/template/imagenes/cajas/<?php echo $array['foto']; ?>">
									</a>
								</div>
							</div>

							<div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-2 col-xs-offset-2 col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<button ng-disabled="cajas.$invalid" class="btn btn-primary" type="submit" id="boton">Editar</button>
