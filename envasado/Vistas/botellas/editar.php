			...
			<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" ng-controller="validarBotellas">
				...
				<?php Vistas\template\plantillas\campoRequerido::index(); ?>
					...
					<span ng-repeat="obj in editBotella">
						...
						<div class="form-group">
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
								...
								placeholder="Ejemplo: Superior 750ml" ng-model="obj.nombre" 
						...
						<div class="form-group">
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
								...
								title="Seleccione una opción" ng-model="obj.distribucion" 
						...
						<div class="form-group">
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
								...
								title="Seleccione una opción" ng-model="obj.proveedor" 
								ng-change="validarNombre()" required>
									<option value="">Seleccione una opción</option>
						...
						<div class="form-group">
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
								...
								title="Seleccione una opción" ng-model="obj.medida" 
								ng-change="validarNombre()" required>
									<option value="">Seleccione una opción</option>
					...
					<div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-2 col-xs-offset-2 col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<button ng-disabled="botellas.$invalid" class="btn btn-primary" type="submit" id="boton">Editar</button>
