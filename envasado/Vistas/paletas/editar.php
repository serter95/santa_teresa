...
?>
<h3 class="titulo">Editar Paleta</h3>
<div class="panel panel-default">
	<div class="panel-heading">
		<div class="panel-title">Editar Paleta</div>
	</div>
			...
			<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" ng-controller="validarPaletas">
				...
				<span ng-repeat="objeto in editPaleta">
					...
					<div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-2 col-xs-offset-2 col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<button ng-disabled="paletas.$invalid" class="btn btn-primary" type="submit" id="boton">Editar</button>
