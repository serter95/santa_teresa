...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 box-principal">
	<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 areaTrabajo">
		<h3 class="titulo">Editar Proveedor</h3>
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="panel-title">Editar Proveedor</div>
			</div>
						...
						<?php require_once 'Vistas/template/plantillas/campoRequerido.php'; ?>
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
									...
									placeholder="Ejemplo: Venvidrio C.A" ng-model="obj.nombre" 
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
									...
									title="Seleccione una opción" ng-model="obj.estado" 
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
									...
									title="Seleccione una opción" ng-model="obj.municipio" 
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
									...
									ng-model="obj.direccion" title="Ingrese la direccion del proveedor Ej:El concejo, calle..." ng-pattern="'^[A-Za-záéíóúñüÁÉÍÓÚÑÜ 0-9 \.,_-]{10,}'" ng-keyup="validarMunicipio()"
									ng-blur="validarNombreProveedor()" required></textarea>
									<span class="rojoRequired">*</span>
							...
							<div class="form-group inputTelefonos">
								...
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
									...
									placeholder="Ejemplo: 0244" ng-model="obj.codigo" 
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-5">
									...
									placeholder="Ejemplo: 1234455" ng-model="obj.numero" 
							...
							<div class="form-group">
								<label for="nombres" class="col-lg-3 col-md-3 col-sm-3 col-xs-4 control-label">Persona de Contacto: </label>
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
									...
									ng-model="obj.contacto" ng-pattern="'^[A-Za-záéíóúñüÁÉÍÓÚÑÜ]{2,}( [A-Za-záéíóúñüÁÉÍÓÚÑÜ]{2,}( [A-Za-záéíóúñüÁÉÍÓÚÑÜ]{2,})?( [A-Za-záéíóúñüÁÉÍÓÚÑÜ]{2,})?)?'" ng-keyup="validarMunicipio()"
									ng-blur="validarNombreProveedor()" required>
									<span class="rojoRequired">*</span>
							...
							<div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-2 col-xs-offset-2 col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<button ng-disabled="proveedores.$invalid" class="btn btn-primary" type="submit" id="boton">Editar</button>
